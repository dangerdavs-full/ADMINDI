...
public class PropertyFileEntity {
    ...
    private String category; // PHOTO, PLAN, OTHER
    ...
    @Column(length = 50)
    private String label; // BASELINE, UPDATE, BEFORE, AFTER, VISIT, MAINTENANCE, VACANCY, AGREEMENT_EVIDENCE

    @Column(columnDefinition = "TEXT")
    private String note;

    public PropertyFileEntity() {}
